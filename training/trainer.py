...
class Trainer:
    def __init__(self, model, dataset, batch_size=16, lr=1e-4, total_steps=100000, warmup_steps=10000, end_learning_rate=0.0, power=1.0, accumulation_steps=1, device='cuda'):
        """
